...
author: zh
redirect_from:
  - /zh-linyujupiter-homepage/
  - /zh-linyujupiter-homepage/index.html
---
...
我于2025年毕业于中山大学智能工程学院智能科学与技术专业，后进入香港中文大学工程学院信息工程系就读硕士学位。

喜欢编程，曾在Agent时代来临前基于Python开发已上线软件两款(隐私限制，不方便展示)，用户过百，全部前后端开发与运维工作由我一人完成。现如今由于AI编程的兴起，编写一个简单软件已不再是一件难事，但亲手编写软件的成就感仍在我心中难以忘怀。[本站](/zh/)是我自己搭建的网站主页，[这里](http://134.175.123.166:3003)是我的博客网站，欢迎访问。

曾加入[高陈强](https://gaocq.github.io/index.html)教授的课题组协助参与部分科研任务，方向为计算机视觉，主要参与教室场景下群体行为检测任务。发表有SCI四区论文一篇。
